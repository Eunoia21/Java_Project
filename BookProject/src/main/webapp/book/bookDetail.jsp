   ...
   <input type="hidden" name="num" value="${book.num}">
      <div id="bookdetail">
         ...
         <div id="book2">
            ...
            <div id="book2text">
               <br>
               <p><b>카테고리</b> &nbsp; ${book.category}</p>
               <br>
               <h2>${book.title}</h2>
               <p>
                  <b>작가</b>&nbsp;${book.author} &#124; <b>출판사</b>&nbsp;${book.pub}
               </p>
               <p><b>가격</b>&nbsp;${book.price}&nbsp;원</p>
               <br><br>
               <p><b>줄거리</b><br>${book.summary}</p>
            </div>
         </div>
      </div>
      ...
      <br><br>
      <input type="button" value="도서 목록" id="button" onclick="location.href='BookServlet?command=book_list'">
      <c:if test="${member.lev == 'A'}">
      <input type="button" value="도서 등록" id="button" onclick="location.href='BookServlet?command=book_register_form'">
      <input type="button" value="도서 수정" id="button" onclick="location.href='BookServlet?command=book_update_form&num=${book.num}'">
      <input type="submit" value="도서 삭제" id="button" onclick="return deleteCheck()">
      </c:if>
   </form>
  </div>
   <footer>
